...
const makeRequestMumbai = async () => {
  ...
  const privateKey = "39040064edff499078ce6c730dc2a8781c422bd747f7c7b0c30e0d5cf01cee25"; // fetch PRIVATE_KEY
  if (!privateKey)
    throw new Error(
      "private key not provided - check your environment variables"
    );

  const FUJI_RPC_URL = "https://avalanche-fuji.infura.io/v3/00606488a2344f3eb25aec8bef04189d";
  // const rpcUrl = process.env.FUJI_RPC_URL; // fetch mumbai RPC URL
  const rpcUrl = FUJI_RPC_URL; // fetch mumbai RPC URL
